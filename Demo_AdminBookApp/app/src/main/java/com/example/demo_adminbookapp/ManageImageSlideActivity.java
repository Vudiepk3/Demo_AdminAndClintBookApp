...
import com.example.demo_adminbookapp.databinding.ActivityManageImageSlideBinding;
import com.example.demo_adminbookapp.model.BannerImageModel;
...
public class ManageImageSlideActivity extends AppCompatActivity {
    ...
    ActivityManageImageSlideBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityManageImageSlideBinding.inflate(getLayoutInflater());
        ...
        storageReference.putFile(imageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                storageReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        database.getReference().child("banner_image").child(firebasePath).setValue(imageModel)
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void unused) {
                                        Toast.makeText(ManageImageSlideActivity.this, "Image Uploaded", Toast.LENGTH_SHORT).show();
                                    }
                                }).addOnFailureListener(new OnFailureListener() {
                                    @Override
                                    public void onFailure(@NonNull Exception e) {
                                        Toast.makeText(ManageImageSlideActivity.this, "Image Not Uploaded", Toast.LENGTH_SHORT).show();
                                    }
                                });
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(ManageImageSlideActivity.this, "Failed to get download URL", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(ManageImageSlideActivity.this, "Image Upload Failed", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void loadBannerImage(StorageReference imageRef, ImageView imageView) {
        imageRef.getDownloadUrl().addOnSuccessListener(uri -> {
            Glide.with(ManageImageSlideActivity.this)
                    .load(uri)
    ...
    private void pickImage(ActivityResultLauncher<Intent> launcher) {
        ...
        ImagePicker.Companion.with(this)
                    .saveDir(ManageImageSlideActivity.this.getExternalFilesDir(Environment.DIRECTORY_PICTURES))
                .galleryOnly()
