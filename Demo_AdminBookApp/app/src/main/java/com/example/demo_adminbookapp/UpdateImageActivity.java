...
public class UpdateImageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                new ActivityResultCallback<ActivityResult>() {
                    ...
                    public void onActivityResult(ActivityResult result) {
                        if (result.getResultCode() == Activity.RESULT_OK){
                            ...
                            Toast.makeText(UpdateImageActivity.this, "Không ảnh nào được chọn", Toast.LENGTH_SHORT).show();
                        }
                    }
                }
        );
        ...
        if (bundle != null){
            Glide.with(UpdateImageActivity.this).load(bundle.getString("UrlImage")).into(updateUrlImage);
    ...
    public void saveDataWithNewImage(){
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(UpdateImageActivity.this);
        ...
        databaseReference.setValue(dataClass).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    ...
                    Toast.makeText(UpdateImageActivity.this, "Cập nhật thành công", Toast.LENGTH_SHORT).show();
                    finish();
