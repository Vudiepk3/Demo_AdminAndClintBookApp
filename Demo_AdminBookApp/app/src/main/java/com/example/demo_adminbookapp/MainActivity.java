    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btnShow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent showAllDocumentActivity = new Intent(MainActivity.this, ShowAllDocumentActivity.class);
                startActivity(showAllDocumentActivity);
            }

        });
        binding.btnManageImageSlide.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent manageImageSlide = new Intent(MainActivity.this, ManageImageSlideActivity.class);
                startActivity(manageImageSlide);
            }
    ...
    private ActivityResultLauncher<String> launcher = registerForActivityResult(
            ...
            new ActivityResultCallback<Uri>() {
                ...
                public void onActivityResult(Uri uri) {
                    pdfFileUri = uri;
                    if ((uri != null)) {
                        assert DocumentFile.fromSingleUri(MainActivity.this, uri) != null;
                        fileName = DocumentFile.fromSingleUri(MainActivity.this, uri).getName();
                    } else {
                        fileName = null;
                    }
